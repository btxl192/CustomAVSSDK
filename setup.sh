...
CLONE_URL="https://github.com/btxl192/CustomAVSSDK"
...
then
  ...
  then
    ...
    git reset --hard 8d0af516bde962dc41aa5b612db1891738454056
  ...
  cmake "$SOURCE_PATH/avs-device-sdk" \
      ...
      -DCAPTIONS=ON \
      -DLIBWEBVTT_LIB_PATH="$HOME/webvtt/build/src/webvtt/liblibwebvtt.dll.a" \
      -DLIBWEBVTT_INCLUDE_DIR="$HOME/webvtt/include"
...
cp "$HOME/webvtt/build/src/webvtt/libwebvtt.dll" "$HOME/build/bin"
mv "$HOME/avs-device-sdk/host_output.py" "$HOME"
mv "$HOME/avs-device-sdk/startapp.bat" "$HOME"
mv "$HOME/avs-device-sdk/startaudiohost.bat" "$HOME"